...
get_header(); ?>
    ...
    <?php get_template_part( 'template-parts/nav' ); ?>
        ...
        <header class="hero off-page-header videos">
                    ...
                    <!-- sidebar went here -->
                        ...
                        <div class="product-content">
                            ...
                            <div class="padded-content">
                                <iframe src="https://player.vimeo.com/video/240213213" style="width:38rem;height:18rem;" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen>
                            </div>
